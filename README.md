...
Tu liga directa es:
```text
https://blog-mcy.onrender.com/posts/blog-0-hola-mundo.html
```
...
3. Tu liga oficial directa a la publicación ya viene precargada: `https://blog-mcy.onrender.com/posts/blog-0-hola-mundo.html`.
